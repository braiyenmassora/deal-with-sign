...
const Hero = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="text-white body-font flex items-center h-screen">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-start">
          <div className="md:w-1/2 md:pr-16 animate-bottom-fade">
            <h1 className="text-5xl font-bold text-white mb-10">
              Data Engineer<br /> & Flutter Developer.
            </h1>
      ...
      <section className="text-white body-font overflow-hidden h-screen">
          ...
          <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="py-8 flex flex-wrap md:flex-nowrap">
              ...
              <div className="md:flex-grow">
                ...
                <a href="#" className="inline-flex items-center mt-4 text-base font-normal text-white underline">Learn More {/* Added "underline" class */}
